...
import { colorValidation, sizeRangeValidation } from '../../style/validators';
import { getStyles } from '../../style/deck-styles';
import { CartoStylingError } from '../../errors/styling-error';

describe('Validators', () => {
  describe('colorValidation', () => {
    it('fails with invalid colors', () => {
      const colors = ['', '#', '#12', '#12345', '#1234567', '#123456789', '#000000W'];
