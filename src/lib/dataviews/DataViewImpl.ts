...
import { DataViewMode, DataViewData, HistogramDataViewResult } from './mode/DataViewMode';
...
export abstract class DataViewImpl<T extends DataViewMode> extends WithEvents {
  ...
  public abstract async getData(): Promise<Partial<DataViewData> | HistogramDataViewResult>;
}
