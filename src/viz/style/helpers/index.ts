...
export { colorBinsStyle, ColorBinsOptionsStyle } from './color-bins-style';
export { colorCategoriesStyle, ColorCategoriesOptionsStyle } from './color-categories-style';
export { colorContinuousStyle, ColorContinuousOptionsStyle } from './color-continuous-style';
