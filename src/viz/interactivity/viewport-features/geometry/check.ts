...
const checkGeometryFunctions: Record<GeometryTypes, Function> = {
  [GeometryTypes.Point](coordinates: GeoJSON.Position, frustumPlanes: ViewportFrustumPlanes) {
  ...
  [GeometryTypes.MultiLineString](
    ...
    return lines.map(line => checkGeometryFunctions.LineString(line, frustumPlanes));
  },
  ...
  [GeometryTypes.MultiPolygon](
    ...
    return polygons.some(polygon => checkGeometryFunctions.Polygon(polygon, frustumPlanes));
  }
};
